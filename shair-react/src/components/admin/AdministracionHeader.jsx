  ...
  const seleccionHeader = () => {
    if (seccion === 0) {
      return (
        <>
          <motion.section
            className="seccionAdministracionHeader"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.25 }}
          >
            <nav
              className="navegacionSeccionAdministracionHeader"
              style={{ backgroundColor: "rgb(4, 50, 77)" }}
            >
          ...
          <motion.section
            className="seccionAlternativaAdministracionHeader"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.25 }}
          >
        ...
        <>
          ...
          >
            <nav className="navegacionSeccionAlternativaAdministracionHeader">
              <button
                type="button"
                onClick={accesoSubSeccion1}
                style={{
                  backgroundColor:
                    subSeccion === 1 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Administradores
              </button>
              <button
                type="button"
                onClick={accesoSubSeccion2}
                style={{
                  backgroundColor:
                    subSeccion === 2 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Crear administrador
              </button>
        ...
        <>
          ...
          >
            <nav className="navegacionSeccionAlternativa6AdministracionHeader navegacionSeccionAlternativaAdministracionHeader">
              <button
                type="button"
                onClick={accesoSubSeccion8}
                style={{
                  backgroundColor:
                    subSeccion === 8 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Recomendaciones
              </button>
        ...
        <>
          ...
          >
            <nav className="navegacionSeccionAlternativaAdministracionHeader">
              <button
                type="button"
                onClick={accesoSubSeccion3}
                style={{
                  backgroundColor:
                    subSeccion === 3 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Noticias
              </button>
              <button
                type="button"
                onClick={accesoSubSeccion4}
                style={{
                  backgroundColor:
                    subSeccion === 4 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Crear noticias
              </button>
        ...
        <>
          ...
          >
            <nav className="navegacionSeccionAlternativa4AdministracionHeader navegacionSeccionAlternativaAdministracionHeader">
              <button
                type="button"
                onClick={accesoSubSeccion5}
                style={{
                  backgroundColor:
                    subSeccion === 5 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Anuncios
              </button>
              <button
                type="button"
                onClick={accesoSubSeccion6}
                style={{
                  backgroundColor:
                    subSeccion === 6 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Crear anuncios
              </button>
        ...
        <>
          ...
          >
            <nav className="navegacionSeccionAlternativa5AdministracionHeader navegacionSeccionAlternativaAdministracionHeader">
              <button
                type="button"
                onClick={accesoSubSeccion7}
                style={{
                  backgroundColor:
                    subSeccion === 7 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)",
                }}
              >
                Recomendaciones
              </button>
