  ...
  const enviarFormularioSuperadministrador = async (e) => {
    ...
    try {
      const respuesta = await axios.post(
        `http://${localIP}:5000/superadministradorlogin`,
        {
          email: valorEmail,
    ...
    >
        ...
        <form className="tarjetaFormularioCuerpoFormulario">
          ...
          <fieldset className="tarjetaFormularioCuerpoFormularioGrupo">
            ...
            {validacionError.contraseña && (
              <motion.span className="tarjetaFormularioCuerpoFormularioError">
                {validacionError.contraseña}
              </motion.span>
            )}
          </fieldset>
      ...
      <footer className="tarjetaFormularioPie">
        ...
        <button
          className="tarjetaFormularioPieBoton"
          type="submit"
          onClick={enviarFormularioSuperadministrador}
        >
          Acceder
        </button>
      </footer>
