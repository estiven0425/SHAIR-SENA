        ...
        if (seccion === 0) {
            ...
            return (
                <>
                    <section className="seccionAdministracionHeader">
                        <nav className="navegacionSeccionAdministracionHeader" style={{ backgroundColor: "rgb(4, 50, 77)" }}>
                            <button type="button" onClick={accesoSeccion3}>Noticias</button>
                        </nav>
                        <nav className="navegacionSeccionAdministracionHeader" style={{ backgroundColor: "rgb(4, 50, 77)" }}>
                            <button type="button" onClick={accesoSeccion4}>Anuncios</button>
                        </nav>
                        <nav className="navegacionSeccionAdministracionHeader" style={{ backgroundColor: "rgb(4, 50, 77)" }}>
                            <button type="button" onClick={accesoSeccion5}>Recomendaciones</button>
                        </nav>
                    </section>
                    <section className="seccionAlternativaAdministracionHeader">
                        <nav className="navegacionSeccionAlternativaAdministracionHeader">
            ...
            return (
                <>
                    ...
                    <section className="seccionAlternativaAdministracionHeader">
                        <nav className="navegacionSeccionAlternativaAdministracionHeader">
                            <button type="button" onClick={accesoSubSeccion3} style={{ backgroundColor: subSeccion === 3 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)" }}>Noticias</button>
                            <button type="button" onClick={accesoSubSeccion4} style={{ backgroundColor: subSeccion === 4 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)" }}>Crear noticias</button>
                        </nav>
                    </section>
                </>)
        } else if (seccion === 4) {
                ...
                <>
                    ...
                    <section className="seccionAlternativaAdministracionHeader">
                        <nav className="navegacionSeccionAlternativa4AdministracionHeader">
                            <button type="button" onClick={accesoSubSeccion5} style={{ backgroundColor: subSeccion === 5 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)" }}>Anuncios</button>
                            <button type="button" onClick={accesoSubSeccion6} style={{ backgroundColor: subSeccion === 6 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)" }}>Crear anuncios</button>
                        </nav>
                    </section>
                </>)
        } else if (seccion === 5) {
                ...
                <>
                    ...
                    <section className="seccionAlternativaAdministracionHeader">
                        <nav className="navegacionSeccionAlternativa5AdministracionHeader">
                            <button type="button" onClick={accesoSubSeccion7} style={{ backgroundColor: subSeccion === 7 ? "rgb(57, 169, 0)" : "rgb(4, 50, 77)" }}>Recomendaciones</button>
                        </nav>
                    </section>
                </>)
        }
