...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 22:16:10
...
(29, 'Administrador', 'administrador@shair.com', 3024446708, NULL, '$2b$10$SZduCUpev5aJoO./boXIOeIttHZyfi4hDTIdytk4/oGmcEaGIO10q', '2024-08-01 21:04:08'),
(34, 'Administrador 2', 'administrador2@shair.com', 3002981090, NULL, '$2b$10$J5H0VvCsFtMiMS7kmLIElOP8Bnd4ojuYPIYOvehafMwgtBmhjwKKO', '2024-08-05 19:52:21'),
...
(7, '¿Qué son los anuncios?', 'Los anuncios son noticias de mayor impacto, que no buscan difundir información de eventos, si no, alertas temporales como avisos urgentes o solicitudes temporales, estos desaparecen pasado el tiempo de expiración (Función pendiente de desarrollo)', 'uploads/logo.png', '2030-12-31', 'Preguntar al equipo de desarrollo', 29),
(8, '¿Cómo funciona la edición?', 'Al editar una noticia o anuncio, este pasa a ser propiedad del administrador que lo modificó por última vez, impidiendo de esta manera que se haga usurpación de identidad', 'uploads/logo.png', '2030-12-31', 'Preguntar al equipo de desarrollo', 29),
(13, 'Derecho de autenticidad', 'Ahora las noticias y anuncios cuentan con una protección para evitar su robo', 'uploads/logo.png', '2030-12-30', 'Preguntar al equipo de desarrollo', 35);
...
(46, '¿Qué son las noticias? kudhjanlkdjakldnasldlas', 'Las noticias son comunicados sobre eventos que se llevaran a cabo, estos eventos los pueden programar los diferentes entes de la institución', 'uploads/logo.png', 'Oficinas de SHAIR', '2024-06-20', '2030-12-31', 'Preguntar al equipo de desarrollo', 29),
(47, '¿Cómo funciona SHAIR?', 'SHAIR clasifica su contenido en noticias y anuncios, cada uno con un propósito y función diferente; SHAIR es administrador por dos roles, superadministrador y administrador, el superadministrador tiene control sobre los administradores y sus noticias, mientras que los administradores tienen control sobre las noticias, anuncios y recomendaciones', 'uploads/logo.png', 'Oficinas de SHAIR', '2024-06-20', '2030-12-31', 'Preguntar al equipo de desarrollo', 29),
(53, 'Actualización noticias y anuncios', 'Ahora las noticias y anuncios desaparecen pasada el tiempo de finalización, además, se ha corregido la falla de seguridad al momento de editar las noticias, ahora solo se pueden editar las noticias propias', 'uploads/logo.png', 'Oficias de SHAIR', '2024-08-01', '2030-12-31', 'Preguntar al equipo de desarrollo', 34);
...
(1, 'Superadministrador', 'superadministrador@shair.com', 324201881, NULL, '$2b$10$SZduCUpev5aJoO./boXIOeIttHZyfi4hDTIdytk4/oGmcEaGIO10q', 'Gerente', '2024-06-12 18:34:12');
...
--
ALTER TABLE `administrador`
  MODIFY `id_administrador` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
